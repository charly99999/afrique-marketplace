...
export default function ListingDetail({ id }: { id: string }) {
  ...
  if (!listing) return <MarketplaceShell><section className="page-wrap section-space"><div className="gate-card"><h2>Cette annonce n’est plus disponible.</h2><Link href="/annonces" className="button button--gold">Voir les annonces</Link></div></section></MarketplaceShell>;
