...
export default function Verification() {
  ...
  const pickDocument = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) setDocumentData(await fileToDataUrl(file));
  };
