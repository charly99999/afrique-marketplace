...
export default function Verification() {
  ...
  const handleSubmit = async (event: React.FormEvent) => {
    ...
    if (isSupabaseMode) {
      ...
      try {
        const preflight = await runLocalKycPreflight(documentData, selfieData);
